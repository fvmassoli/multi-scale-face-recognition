...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.conv2_1_1x1_down = self.__conv(2, name='conv2_1_1x1_down', in_channels=256, out_channels=16, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv2_1_1x1_up = self.__conv(2, name='conv2_1_1x1_up', in_channels=16, out_channels=256, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv2_2_1x1_down = self.__conv(2, name='conv2_2_1x1_down', in_channels=256, out_channels=16, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv2_2_1x1_up = self.__conv(2, name='conv2_2_1x1_up', in_channels=16, out_channels=256, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv2_3_1x1_down = self.__conv(2, name='conv2_3_1x1_down', in_channels=256, out_channels=16, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv2_3_1x1_up = self.__conv(2, name='conv2_3_1x1_up', in_channels=16, out_channels=256, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv3_1_1x1_down = self.__conv(2, name='conv3_1_1x1_down', in_channels=512, out_channels=32, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv3_1_1x1_up = self.__conv(2, name='conv3_1_1x1_up', in_channels=32, out_channels=512, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv3_2_1x1_down = self.__conv(2, name='conv3_2_1x1_down', in_channels=512, out_channels=32, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv3_2_1x1_up = self.__conv(2, name='conv3_2_1x1_up', in_channels=32, out_channels=512, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv3_3_1x1_down = self.__conv(2, name='conv3_3_1x1_down', in_channels=512, out_channels=32, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv3_3_1x1_up = self.__conv(2, name='conv3_3_1x1_up', in_channels=32, out_channels=512, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv3_4_1x1_down = self.__conv(2, name='conv3_4_1x1_down', in_channels=512, out_channels=32, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv3_4_1x1_up = self.__conv(2, name='conv3_4_1x1_up', in_channels=32, out_channels=512, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_1_1x1_down = self.__conv(2, name='conv4_1_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_1_1x1_up = self.__conv(2, name='conv4_1_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_2_1x1_down = self.__conv(2, name='conv4_2_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_2_1x1_up = self.__conv(2, name='conv4_2_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_3_1x1_down = self.__conv(2, name='conv4_3_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_3_1x1_up = self.__conv(2, name='conv4_3_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_4_1x1_down = self.__conv(2, name='conv4_4_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_4_1x1_up = self.__conv(2, name='conv4_4_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_5_1x1_down = self.__conv(2, name='conv4_5_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_5_1x1_up = self.__conv(2, name='conv4_5_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv4_6_1x1_down = self.__conv(2, name='conv4_6_1x1_down', in_channels=1024, out_channels=64, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv4_6_1x1_up = self.__conv(2, name='conv4_6_1x1_up', in_channels=64, out_channels=1024, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        ...
        self.conv5_1_1x1_down = self.__conv(2, name='conv5_1_1x1_down', in_channels=2048, out_channels=128, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
        self.conv5_1_1x1_up = self.__conv(2, name='conv5_1_1x1_up', in_channels=128, out_channels=2048, kernel_size=(1L, 1L), stride=(1L, 1L), groups=1, bias=True)
